...
<svg xmlns="http://www.w3.org/2000/svg" width="640" viewBox="0 0 840 470" role="img" aria-labelledby="barrier-title barrier-desc" style="display:block;max-width:100%;height:auto;margin:20px auto;">
  ...
  <g fill="#000" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', Arial, sans-serif" dominant-baseline="middle">
  ...
  <g fill="#000" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', Arial, sans-serif" dominant-baseline="middle" text-anchor="start">
